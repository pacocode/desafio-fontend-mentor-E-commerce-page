    ...
    <section className="absolute top-[125%] left-0 z-10 w-full md:left-full md:top-full md:max-w-lg md:-translate-x-full">
      <div className="mx-4 rounded-md bg-white shadow-md">
        ...
        {cartProducts.length === 0 && (
          <p className="py-16 text-center">Your car is empty</p>
        )}
        {cartProducts.map((product) => (
          <article
            ...
            <div>
              ...
              <p>
                <span>
                  ${product.discount} x {product.quantity}
                </span>
        ...
        {cartProducts.length != 0 && (
          <div className="px-6 pb-8">
            <button className="w-full rounded-md bg-orange-primary py-4 text-white transition hover:bg-orange-700">
              Checkout
            </button>
          </div>
        )}
